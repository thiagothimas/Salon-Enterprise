...
namespace SalonEnterpriseAplication.Migrations
{
    ...
    [Migration("20190527001943_FuncionarioMovimentacao")]
    partial class FuncionarioMovimentacao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.ClienteServico", b =>
                {
                    b.Property<int>("ClienteId");

                    b.Property<int>("ServicosRealizadosId");

                    b.HasKey("ClienteId", "ServicosRealizadosId");

                    b.HasIndex("ServicosRealizadosId");

                    b.ToTable("tb_cliente_servicos");
                });
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.Movimentacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.OrdemServico", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.ServicosRealizados", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("tb_servicos_realizados");
                });

            modelBuilder.Entity("SalonEnterpriseAplication.Models.ServicoVenda", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.ClienteServico", b =>
                {
                    b.HasOne("SalonEnterpriseAplication.Models.Cliente", "Cliente")
                        .WithMany("ClientesServicos")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("SalonEnterpriseAplication.Models.ServicosRealizados", "ServicosRealizados")
                        .WithMany()
                        .HasForeignKey("ServicosRealizadosId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.Movimentacao", b =>
                {
                    b.HasOne("SalonEnterpriseAplication.Models.Funcionario", "funcionario")
                        .WithMany()
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.ServicosRealizados", b =>
                {
                    ...
                    b.HasOne("SalonEnterpriseAplication.Models.OrdemServico", "OrdemServico")
                        .WithMany()
            ...
            modelBuilder.Entity("SalonEnterpriseAplication.Models.VendaProduto", b =>
                {
                    ...
                    b.HasOne("SalonEnterpriseAplication.Models.ServicoVenda", "ServicoVenda")
                        .WithMany("Servicos")
