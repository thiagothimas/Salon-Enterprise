...
using SalonEnterpriseAplication.App_Start.Identity;
using Microsoft.Owin.Security.Cookies;
using Microsoft.Owin.Security.Google;
using System.Configuration;

[assembly: OwinStartup(typeof (SalonEnterpriseAplication.Startup))]

namespace SalonEnterpriseAplication
{
		...
		public void Configuration(IAppBuilder builder)
		{
			...
			builder.CreatePerOwinContext<UserManager<UsuarioAplicacao>>(
				(opcoes, contextoOwin) =>
				{
					...
					var dataProtectionProviderCreated = dataProtectionProvider.Create("SalonEnterpriseAplication");
